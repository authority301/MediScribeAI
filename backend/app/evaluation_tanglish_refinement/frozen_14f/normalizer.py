...
============================================================================
STEP 14I NOTE -- FROZEN SNAPSHOT
============================================================================
This file is a BYTE-IDENTICAL-LOGIC snapshot of
`backend/app/tanglish/normalizer.py` as it existed at commit 5563418 (the
Step 14F/14G checkpoint), before Step 14H's numeric-preservation and
attribution-safety refinement changed that file in place. ONLY the
`app.tanglish...` imports below were rewritten to resolve against this
snapshot package instead. See `frozen_14f/__init__.py` for why this exists.
Never imported by production code.
"""
import re
from dataclasses import dataclass

from app.evaluation_tanglish_refinement.frozen_14f import lexicon
from app.evaluation_tanglish_refinement.frozen_14f.config import ENTITY_TRIGGER_WINDOW_CHARS
from app.evaluation_tanglish_refinement.frozen_14f.schemas import NormalizedTextResult, SemanticFeatures, Transformation
